...
from keras_retinanet.bin.evaluate_overall_patient_wise import draw_colorful_result, evaluate_from_npy
...
def _print_ensemble_detections_to_npy(args, generator, model_list, client_idx, client_name, patient_name, score_threshold=0.05, max_detections=100, save_path=None):
    ...
    for i in tqdm(range(generator.size()), desc='Running network on {} {}: '.format(client_name, patient_name)):
        ...
        # filter out of lung
        if args.lung_filter:
            # client_paths = ['private_1', 'private_2', 'private_3', 'public_4']
            # client_paths = ['private_4/B']
            client_paths = ['public_4']
...
def main(args=None):
    ...
    # print model summary
    # print(model.summary())
    # client_name = ['siteA', 'siteB', 'siteC', 'siteF']
    # client_name = ['Dataset4'] # SZ
    client_name = ['Dataset6'] # public
    # data_path = ['public_4/h5_normalize', 'private_1/h5_normalize', 'private_2/h5_normalize', 'private_3/h5_normalize', 'mos/h5_normalize_repeat']
    # data_path = ['private_1/h5_normalize', 'mos/h5_normalize_repeat']
    # data_path = ['private_1/h5_normalize_-1050_1500', 'private_2/h5_normalize_-1050_1500', 'private_3/h5_normalize_-1050_1500', 'public_4/h5_normalize_-1050_1500']
    # data_path = ['private_4/B/h5_normalize']
    # data_path = ['private_4/B/h5_normalize_-1050_800']
    data_path = ['public_4/h5_normalize']
    # data_path = ['public_4/h5_normalize_-1050_800']
    # test_data_list = ['test_private_1_whole_vol.csv', 'test_private_2_whole_vol.csv', 'test_private_3_whole_vol.csv', 'test_public_4_whole_vol.csv']
    # test_data_list = ['test_private_1.csv', 'test_private_2.csv', 'test_private_3.csv', 'test_public_4.csv']
    # test_data_list = ['P5_annotations_h5_whole_vol.csv', 'test_private_2_whole_vol.csv', 'test_private_3_whole_vol.csv', 'test_public_4_all_whole_vol.csv']
    # test_data_list = ['all_annotations_h5_whole_vol.csv']
    # test_data_list = ['all_deleted_6_annotations_h5_whole_vol.csv']
    public_4 = ['coronacases001_annotations_h5_whole_vol.csv', 'coronacases002_annotations_h5_whole_vol.csv',
                'coronacases003_annotations_h5_whole_vol.csv', 'coronacases004_annotations_h5_whole_vol.csv',
                'coronacases005_annotations_h5_whole_vol.csv', 'coronacases006_annotations_h5_whole_vol.csv',
                'coronacases007_annotations_h5_whole_vol.csv', 'coronacases008_annotations_h5_whole_vol.csv',
                'coronacases009_annotations_h5_whole_vol.csv', 'coronacases010_annotations_h5_whole_vol.csv']
    ...
    test_data_list = [public_4]
    # test_data_list = [public_4]
    axial_resolution_public_4 = [0.8105, 0.6836, 0.7363, 0.6836, 0.6836, 0.7598, 0.7129, 0.7246, 0.6836, 0.6836]
    axial_resolution_private_4 = [0.6918, 0.782, 0.714, 0.698, 0.7379, 0.7107, 0.723, 0.7108, 0.6511, 0.695]
    test_data_resolution = [axial_resolution_public_4]
    # test_data_resolution = [axial_resolution_public_4]
    ...
    # start evaluation
    log_path = args.log if args.log else './evaluate_dataser4_ensemble_patient-wise-log_1_Jun.txt'
    ...
    for i in range(len(client_name)):
        ...
        for j in range(len(test_data_list[i])):
            patient_name = patient_names[client_name[i]][j]
            average_precisions, old, new, lesion_size, num_annotations, num_slices = evaluate_from_npy(
                args,
                client_name=client_name[i],
                patient_name=patient_name,
